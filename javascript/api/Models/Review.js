...
class Review {
    ...
    static async createReview (userData) {
        ...
        const response = await db.query("INSERT INTO review (rating, movie_name, user_id) VALUES($1, $2, $3) RETURNING *", [userData.rating, userData.movie_name, userData.user_id])
